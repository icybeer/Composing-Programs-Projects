...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    while (True):
        ...
        if (score == 0 or opponent_score == 0):
            pass
        elif (score / opponent_score == 2 or score / opponent_score == 0.5):
            tmp = score
...
def max_scoring_num_rolls(dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    for i in range(1,11):
        print('{0} dice scores {1} on average'.format(i, make_averaged(roll_dice)(i, dice)))
    print (i)
    return
...
def bacon_strategy(score, opponent_score):
    ...
    """
    "*** YOUR CODE HERE ***"
    if (opponent_score % 10 +1 >=BACON_MARGIN or opponent_score // 10 +1 >=BACON_MARGIN):
        return 0
...
def swap_strategy(score, opponent_score):
    ...
    if (opponent_score%10 > opponent_score//10):
        ...
        bacon = opponent_score//10 + 1
    if (score + bacon == opponent_score/2):
        return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if (opponent_score%10 > opponent_score//10):
        ...
        bacon = opponent_score//10 + 1
    hogwild = ((bacon + score + opponent_score) %7==0)
    if(swap_strategy(score,opponent_score)==0):
        return 0
    elif(hogwild):
        return 0
    elif(score>80):
        if(bacon>7 and swap_strategy(score,opponent_score)!= BASELINE_NUM_ROLLS):
            return 0
    elif (score>60):
        return 4
    if (score<20):
